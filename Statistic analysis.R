...
X_2_diff[X_2_diff<0]<-X_2_diff[X_2_diff<0]+9
...
# Plot histogram of the observed data
hist(bootdiff2 , freq = FALSE, col = "lightblue", main = "Fitted Normal Distribution", xlab = "Bootstrap Observed Data")
